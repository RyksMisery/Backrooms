...
const BOB_VERTICAL := 0.018        # м, просадка на каждый шаг
const BOB_LATERAL  := 0.022        # м, перевал с ноги на ногу
const BOB_ROLL     := 0.008        # рад, крен в сторону опорной ноги (~0.5°)
